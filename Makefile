...
#    Updated: 2024/03/29 11:54:04 by mconreau         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PROJECT_SOURCES			:=	$(addprefix $(FOLDER_SOURCES)/, get_next_line.c		\
...
ifdef BUFFER_SIZE
V_BUFFER_SIZE			:=	-D BUFFER_SIZE=${BUFFER_SIZE}
endif
V_COUNTER				:=	1
...
%$(EXTENSION_OBJECT)	:	%$(EXTENSION_SOURCE)
							...
							@$(COMPILER_OBJECTS) $(V_BUFFER_SIZE) $(COMPILER_OBJECTS_FLAGS) $(V_INCLUDE_HEADERS) -c $< -o $@
